...
- **Gemini 3.1 TTS on Agent Platform**: Provides the charismatic voice of the AI host/judge, dynamically generating realistic, synthesized speech for the welcome message, prompt analysis, and final judgment.
